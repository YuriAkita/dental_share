class User < ApplicationRecord
  ...
  enum orthodontics_type: { マウスピース矯正: 1, ワイヤー矯正: 2, ワイヤー裏側矯正: 3, ハーフリンガル矯正（上顎側に裏側矯正、下顎側にワイヤー矯正を施す矯正方法）: 4,
                            コンビネーション矯正（治療の前半をワイヤー矯正、治療の後半をマウスピース矯正）: 5, キレイライン: 6, 'Oh my teeth':7, インビザライン: 8, インビザラインiGO: 9,インビザラインティーン: 10, インビザライン・エクスプレスパッケージ: 11, インビザライン・ライトパッケージ: 12, イークライナー: 13, アクアシステム: 14, DENマウスピース: 15 }
end
